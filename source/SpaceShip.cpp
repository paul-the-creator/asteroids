...
void SpaceShip::draw()
{
    ...
    glBegin(GL_LINE_LOOP);
        glVertex2f(0, MAX_LENGTH);
        glVertex2f(0.6*MAX_LENGTH, -0.5*MAX_LENGTH);
        glVertex2f(0, 0);
        glVertex2f(-0.6*MAX_LENGTH, -0.5*MAX_LENGTH);
    glEnd();
    ...
    glBegin(GL_LINES);
        glVertex2f(-0.25*MAX_LENGTH, -0.5*MAX_LENGTH);
        glVertex2f(-0.25*MAX_LENGTH, -0.5*MAX_LENGTH - engTrack);
        glVertex2f(0, -0.5*MAX_LENGTH);
        glVertex2f(0, -0.5*MAX_LENGTH - engTrack);
        glVertex2f(0.25*MAX_LENGTH, -0.5*MAX_LENGTH);
        glVertex2f(0.25*MAX_LENGTH, -0.5*MAX_LENGTH - engTrack);
    glEnd();
